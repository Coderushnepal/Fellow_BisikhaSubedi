            ...
            <div className="portfolio-container">
                ...
                <div className="main-section-container">
                    <form onSubmit={this.handleSubmit}>
                        ...
                        <input onChange={this.handleChange} type="text" id="name" name="name" value={name}/><br/>                    
                        <label htmlFor="email">Email</label><br/>
                        <input onChange={this.handleChange} type="email" id="email" name="email" value={email}/><br/>                    
